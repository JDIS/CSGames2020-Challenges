...
class Quiz():
    ...
    def __init__(self, questions_file):
        ...
        self.intro = '''
Voici le temps de tester vos connaissances sur l'algorithme RSA ! Répondez aux questions suivantes pour obtenir le flag ! Ces questions porterons sur les fondements de l'algorithme et ne devraient pas nécéssiter de calculs trop extravagants.
